...
namespace UMol
{
    namespace API
    {
        public class APIPython : MonoBehaviour
        {
            ...
            public static Transform MoleculeGameObject = null;
                ...
                if (r != null)
                {
                    ...
                    if (newStruct != null)
                    {
                        ...
                        if (paso == "animation")
                        {
                            ...
                            structureParent.transform.position = MoleculeGameObject.position;
                            structureParent.transform.localScale = MoleculeGameObject.localScale;
                        ...
                        if (paso == "molecule")
                        {
                            ...
                            GameObject loadedMolGO = GameObject.Find("LoadedMolecules");
                            GameObject structureParent = loadedMolGO.transform.Find(sel.name).gameObject;
                            MoleculeGameObject = structureParent.transform; // o guardamos el objeto de la molecula para las animaciones
                ...
                if (selM.selections.ContainsKey(selName))
                {
                    ...
                    if (sel.structures != null && sel.structures.Count > 0)
                    {
                        ...
                        if (ret.Count != 0)
                        {
                            ...
                            // Hack :: separamose el ligando lo ocultamos para poder ense�arlo si se llega a poner el objeto
